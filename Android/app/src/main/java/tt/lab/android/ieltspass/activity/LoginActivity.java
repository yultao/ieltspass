...
public class LoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mEmailView = (EditText) findViewById(id.email);
		...
		mLoginStatusView = findViewById(id.login_status);
		mLoginStatusMessageView = (TextView) findViewById(id.login_status_message);

		findViewById(id.sign_in_button).setOnClickListener(new View.OnClickListener() {
			@Override
	...
	public void attemptLogin() {
		...
		if (TextUtils.isEmpty(mPassword)) {
			mPasswordView.setError(getString(string.error_field_required));
		...
		if (cancel) {
			...
			mLoginStatusMessageView.setText(string.login_progress_signing_in);
			showProgress(true);
