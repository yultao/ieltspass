...
public class WritingFragmentScripts extends Fragment {
	private static final String TAG = WritingFragmentScripts.class.getName();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View rootView = inflater.inflate(R.layout.fragment_writing_scripts, container, false);
