...
public class ListeningFragmentLyrics extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		try {
			...
			//tt.lab.android.ieltspass.Logger.i(TAG, "lyrics: \n"+ lyrics);
	...
	private Runnable updateLyricsThread = new Runnable() {
		...
		private void algorithm2() {
			...
			//Sentence sentence = tt.lab.android.ieltspass.Utilities.findSentenceHash(lyrics,cp);
			//tt.lab.android.ieltspass.Utilities.c=0;
			//Sentence sentence = tt.lab.android.ieltspass.Utilities.findSentenceSimple(lyrics.getSentences(),cp);
			Sentence sentence = Utilities.findSentenceBinary(lyrics.getSentences(),cp);
			//tt.lab.android.ieltspass.Logger.i(TAG,"c: "+tt.lab.android.ieltspass.Utilities.c);
			if (sentence != null) {
				TextView textView = (TextView) sentence.getTextView();
				// tt.lab.android.ieltspass.Logger.i(TAG, "equals: " + (textView.equals(lastTextView)));
