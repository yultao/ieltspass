...
public class CenterFragmentLSRW extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		//tt.lab.android.ieltspass.Logger.i(TAG, "onCreateView " + view);
	...
	private void initExpandableList() {
		//tt.lab.android.ieltspass.Logger.i(TAG, "expandableListView: " + expandableListView);
		...
		expandableListView.setOnGroupExpandListener(new OnGroupExpandListener() {
			...
			public void onGroupExpand(int groupPosition) {
				...
				//tt.lab.android.ieltspass.Logger.i(TAG, "onGroupExpand: " + groupPosition);
			}
		});
	...
	private class ExpandableListAdapter extends BaseExpandableListAdapter {
		...
		public int getChildrenCount(int groupPosition) {
			// tt.lab.android.ieltspass.Logger.i(TAG, "getChildrenCount "+groupPosition );
			return generals[groupPosition].length;
		}

		public Object getChild(int groupPosition, int childPosition) {
			// tt.lab.android.ieltspass.Logger.i(TAG, "getChild "+groupPosition +", "+ childPosition);
			return generals[groupPosition][childPosition];
		}

		public long getChildId(int groupPosition, int childPosition) {
			// tt.lab.android.ieltspass.Logger.i(TAG, "getChildId "+groupPosition +", "+ childPosition);
