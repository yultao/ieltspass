...
//		tt.lab.android.ieltspass.Logger.i("sd", "root:　" + Environment.getRootDirectory().getAbsolutePath());
//		tt.lab.android.ieltspass.Logger.i("sd", "data:　" + Environment.getDataDirectory().getAbsolutePath());
//		tt.lab.android.ieltspass.Logger.i("sd", "DownloadCache " + Environment.getDownloadCacheDirectory().getAbsolutePath());
//		tt.lab.android.ieltspass.Logger.i("sd", "ext " + Environment.getExternalStorageDirectory());
//		tt.lab.android.ieltspass.Logger.i("sd", "DIRECTORY_MUSIC " + Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MUSIC));
//		tt.lab.android.ieltspass.Logger.i("sd",
...
//		tt.lab.android.ieltspass.Logger.i(
//				"sd",
...
//		tt.lab.android.ieltspass.Logger.i("sd", "DIRECTORY_DCIM " + Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM));
