...
public class SpeakingFragmentScripts extends Fragment {
	private static final String TAG = SpeakingFragmentScripts.class.getName();
...
//		webSettings.setDefaultZoom(zoomDensity); 
		...
		webView.loadUrl("file://"+settings.getSpeakingScriptsPath()+"/"+questions );
